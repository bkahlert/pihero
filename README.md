...
![Pi Hero Logo](assets%2Fpihero-logo.svg)
...
The gadget is configured using [a shell script](roles/usb_gadget/templates/usb-gadget-setup.sh.j2) that supports any gadget function,
...
⸺̲͞ (((ꎤ ✧曲✧)—̠͞o Samba
  - /home/$USER shares: smb://foo.local/$USER
  - / share: smb://foo.local/rootfs (read-only)
...
[![usb gadget setup log](docs%2Fusb-gadget-setup-log.png)](./docs/usb-gadget-setup-log.png)
